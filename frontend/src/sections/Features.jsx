  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center pt-16 sm:pt-10">
      <div className="flex flex-col lg:flex-row gap-10">
        <div className="relative flex-row-reverse bg-tertiary mx-auto rounded-2xl shadow-xl">
         <div className="flex flex-col items-start px-10 py-20 ">
         <h3 className="text-3xl sm:text-2xl font-bold font-crimson">Blog</h3>
        ...
        <div className="relative flex-row bg-tertiary rounded-2xl max-w-[25rem] mx-auto shadow-xl">
         <div className="flex flex-col items-start px-10 py-20">
      ...
      <div className="flex flex-col lg:flex-row gap-10 pt-8">
        <div className="relative flex-row bg-tertiary rounded-2xl mx-auto max-w-[25rem] shadow-xl">
         <div className="flex flex-col items-start px-10 py-20">
         <h3 className="text-3xl font-bold font-crimson">Blog</h3>
        ...
        <div className="relative flex-row-reverse bg-zinc-900 mx-auto rounded-2xl shadow-xl">
         <div className="flex flex-col items-start px-10 py-20">
