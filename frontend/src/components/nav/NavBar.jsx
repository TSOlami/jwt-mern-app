	...
	return (
		<header className="px-[10px] py-[8px] absolute z-[10px] w-full">
			...
			<nav
				className={
					isNavOpen
						? "bg-white flex flex-col lg:flex-row lg:justify-between md:items-center h-screen lg:h-auto z-10 absolute left-0 w-[315px] lg:static lg:w-auto transition-all duration-400"
						: "bg-white flex flex-col lg:flex-row lg:justify-between md:items-center h-screen lg:h-auto z-10 absolute left-[-100%] w-[315px] lg:static lg:w-auto transition-all duration-400"
				}
			>
